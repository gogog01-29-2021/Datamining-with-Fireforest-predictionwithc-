...
int main() {
    std::string file_path = "250314Shenfeng/combined/group_6_combined.csv";
    ...
    std::ofstream out3("250328rnn_future_results.csv");
    ...
    std::cout << "Results written to 250328rnn_train_results.csv, 250328rnn_test_results.csv, 250328rnn_future_results.csv, and model saved as rnn_model.pth" << std::endl;
    return 0;
}
